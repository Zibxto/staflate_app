...
<head>
	...
	<title>Error</title><!-- Vendor Bundle CSS -->
	...
	<a href="index-2.html" class="btn btn-primary">Back to Home</a></div></div></div></div></div><!-- JavaScript (include all script here) --><script src="assets/js/jquery.bundle49f7.js?ver=104"></script>
	<script src="assets/js/script49f7.js?ver=104"></script></body>
